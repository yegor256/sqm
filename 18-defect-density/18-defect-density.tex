...
\lnThought{Defects are not problems, they are opportunities.}
...
\lnThought{Any imperfection is a defect that deserves to be reported, and then counted.}
...
\lnThought{Defect density may be predicted and even planned.}
