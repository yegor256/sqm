...
\lnQuote
  [Thomas J. McCabe]
  {thomas-mccabe}
  {Cyclomatic Complexity (CC) is a count of the \ul{number of decisions} in the source code. The higher the count, the more complex the code. The formula is simple: \(C=E-N+2\).}
