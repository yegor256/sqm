...
\lnQuote
  [Larry Constantine]
  {larry-constantine}
  {Coupling is reduced when the relationships among elements not in the same module are minimized. There are two ways of achieving this: minimizing the relationships among modules and \hs{maximizing relationships} among elements in the same module.}
...
\lnQuote
  [Wayne P. Stevens]
  {wayne-stevens}
  {One of the most useful techniques for reducing the effect of changes on the program is to make the structure of the design match the structure of the problem, that is, \hs{form should follow function}.}
  {stevens1974structured}
...
\lnQuote
  [Neal Ford]
  {neal-ford}
  {Architecture is the \hs{tension} between coupling and cohesion.}
  {ford2024}
