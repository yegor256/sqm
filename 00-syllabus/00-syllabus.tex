...
Len Bass et al., \hs{Software Architecture in Practice}\\[3pt]
Paul Clements et al., \hs{Documenting Software Architectures: Views and Beyond}\\[3pt]
\nospell{Karl Wiegers} et al., \hs{Software Requirements}\\[3pt]
{\nospell{Alistair Cockburn}}, \hs{Writing Effective Use Cases}\\[3pt]
{\nospell{Steve McConnell}}, \hs{Software Estimation: Demystifying the Black Art}\\[3pt]
{Robert Martin}, \hs{Clean Architecture: A Craftsman's Guide to Software Structure and Design}\\[3pt]
{Steve McConnell}, \hs{Code Complete}\\[3pt]
{Frederick Brooks Jr.}, \hs{Mythical Man-Month, The: Essays on Software Engineering}\\[3pt]
{David Thomas et al.}, \hs{The Pragmatic Programmer: Your Journey To Mastery}\\[3pt]
{Robert C. Martin}, \hs{Clean Code: A Handbook of Agile Software Craftsmanship}\\[3pt]
{\nospell{Grady Booch} et al.}, \hs{Object-Oriented Analysis and Design with Applications}\\[3pt]
{\nospell{Bjarne Stroustrup}}, \hs{Programming: Principles and Practice Using C++}\\[3pt]
{\nospell{Brett McLaughlin} et al.}, \hs{Head First Object-Oriented Analysis and Design: A Brain Friendly Guide to OOA\&D}\\[3pt]
{David West}, \hs{Object Thinking}\\[3pt]
{Eric Evans}, \hs{Domain-Driven Design: Tackling Complexity in the Heart of Software}\\[3pt]
{Yegor Bugayenko}, \hs{Code Ahead}\\[3pt]
{Yegor Bugayenko}, \hs{Elegant Objects}\\[3pt]
{Michael Feathers}, \hs{Working Effectively with Legacy Code}\\[3pt]
{Martin Fowler}, \hs{Refactoring: Improving the Design of Existing Code}\\[3pt]
{Erich Gamma et al.}, \hs{Design Patterns: Elements of Reusable Object-Oriented Software}\\[3pt]
{Martin Fowler}, \hs{UML Distilled}\\[3pt]
{\nospell{Anneke Kleppe} et al.}, \hs{MDA Explained: The Model Driven Architecture: Practice and Promise}\\[3pt]
{\nospell{Jez Humble} et al.}, \hs{Continuous Delivery: Reliable Software Releases through Build, Test, and Deployment Automation}\\[3pt]
{\nospell{Michael T. Nygard}}, \hs{Release It!: Design and Deploy Production-Ready Software}\\[3pt]
\end{multicols}
...
After the course, students \hs{hopefully} will understand:
