...
\lnQuote
  [Bill Curtis]
  {bill-curtis}
  {\ul{Computational} complexity assesses the difficulty of verifying an algorithm's correctness, while \ul{psychological} complexity assesses human performance on programming tasks.}
  {curtis1979measuring}
